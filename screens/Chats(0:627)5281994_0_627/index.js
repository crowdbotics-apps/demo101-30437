    ...
    >
      ...
      >
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/0c936988-1fc4-4355-9c99-6aeb4cd5f5bd"
          }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c3b0416d-5b14-4a55-ac20-aaa768580bb5"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f45b2c05-5348-4f7e-b966-67854cc9b768"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/173f6893-287e-4654-a7bd-5a53890a225d"
        }}
        ...
        <View style={styles.View_I0_784_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d2675683-2e2c-463e-8128-f5d725270641"
              }}
          ...
          <View style={styles.View_I0_784_0_626}>
            <View style={styles.View_I0_784_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/5c01a02c-e8b8-4990-9746-6cb3950474fc"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/da3670c6-95ef-470e-a67a-55e86a604564"
              }}
        ...
        <View style={styles.View_I0_783_0_49}>
          <View style={styles.View_I0_783_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/fe928bf0-066f-4772-a183-0b4fb7fd832a"
              }}
          ...
          <View style={styles.View_I0_783_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/aee0bc8f-7f05-487c-85c2-082a5370d032"
              }}
          ...
          <View style={styles.View_I0_783_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6a4fc054-ec29-423b-8ee6-fe91bfef0c87"
              }}
