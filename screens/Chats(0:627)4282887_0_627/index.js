    ...
    >
      ...
      >
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e276d642-0e0c-419f-a240-0f40250853cd"
          }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e99fab39-7545-4166-888f-1264fcf50e1e"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6be26307-b5e4-4835-a6e3-ccf0d84d7bcb"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/bf0e5beb-7ee8-4924-9d3f-c28d00c47712"
        }}
        ...
        <View style={styles.View_I0_784_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/9cdacc68-c598-4ff2-877f-04e4887ff345"
              }}
          ...
          <View style={styles.View_I0_784_0_626}>
            <View style={styles.View_I0_784_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c91f0e37-6629-458b-ac90-3643f9638e4e"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ba943346-c535-41ba-aff2-adadc24054b2"
              }}
        ...
        <View style={styles.View_I0_783_0_49}>
          <View style={styles.View_I0_783_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/cf704a1d-9c47-43e5-ae72-65afa73610b0"
              }}
          ...
          <View style={styles.View_I0_783_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/621fcd09-fb7c-44d7-88ba-c297d6e4786a"
              }}
          ...
          <View style={styles.View_I0_783_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/96b361b9-a9c6-460e-bd6c-1a4dab575d7f"
              }}
