  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_0_792}>
        ...
        <View style={styles.View_0_818}>
          ...
          <ImageBackground
            source={{
              uri:
                "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/0a19f4ca-9eb2-4752-bdde-376e60c7e5b9"
            }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/28057d70-37cd-40d0-a98c-3532fc309736"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/606bba9b-70a0-4564-9076-49366f37f34d"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/4e6c4ef9-ff4e-47d6-a6aa-8ef0892b17b8"
        }}
        ...
        <View style={styles.View_I0_785_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ed6e5f9f-1e57-4f1d-bca8-b6b1420e676b"
              }}
          ...
          >
            <View style={styles.View_I0_785_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ce17bb2f-5ee1-4202-87e7-7dd53ddb688b"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6378f410-5b49-45a6-8607-609a040cf4d4"
              }}
        ...
        <View style={styles.View_I0_780_0_49}>
          <View style={styles.View_I0_780_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c0b5a0bc-19d3-4230-8336-4f098206df8f"
              }}
          ...
          <View style={styles.View_I0_780_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/178408e3-4900-4cc3-818a-740dbd80c4ef"
              }}
          ...
          <View style={styles.View_I0_780_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/1abd0f78-4961-4360-8164-fcf112709a1b"
              }}
