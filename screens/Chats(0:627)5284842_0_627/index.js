    ...
    >
      ...
      >
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ac0a91ec-88dc-4f95-9ff9-332302563d2b"
          }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c891b694-c8e7-4579-a78c-3ab4648a6a2f"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/a91389f6-b5f8-411c-b60c-13e166047ba7"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c1419952-c6ea-426b-a710-89de28028a0f"
        }}
        ...
        <View style={styles.View_I0_784_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/81e78444-9c99-496e-8cc9-67856c645bde"
              }}
          ...
          <View style={styles.View_I0_784_0_626}>
            <View style={styles.View_I0_784_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3472488e-079e-446c-8b68-b126fe0ba067"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/bb83bad4-5546-4a1b-a082-7e1c4c6e8cd0"
              }}
        ...
        <View style={styles.View_I0_783_0_49}>
          <View style={styles.View_I0_783_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/46dd87bc-ba68-470c-94ae-590769210099"
              }}
          ...
          <View style={styles.View_I0_783_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/48c86e90-5862-4735-8dd1-42ba34fc9967"
              }}
          ...
          <View style={styles.View_I0_783_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/78bab5ef-8d6a-44cb-9f57-0a6f2ee09b18"
              }}
