    ...
    >
      ...
      >
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3e1d7d01-a303-4d4e-8036-3c82f8e25948"
          }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/64dd27a2-8826-4f89-9317-e3646034a900"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3586fbeb-d007-49de-9b44-c1ed2f3bfe96"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f3590050-4537-486f-8d18-1ff7c5d524e5"
        }}
        ...
        <View style={styles.View_I0_784_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/aacb2405-fc22-4ea3-a0b7-26d728d0590a"
              }}
          ...
          <View style={styles.View_I0_784_0_626}>
            <View style={styles.View_I0_784_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/608be694-d28c-409f-8738-5bd762454c1d"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/662bcc8b-0be3-478f-a487-5ecd56aef7be"
              }}
        ...
        <View style={styles.View_I0_783_0_49}>
          <View style={styles.View_I0_783_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/11dffc0d-5cd0-4c73-a53e-14f7ca266a99"
              }}
          ...
          <View style={styles.View_I0_783_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f1ab6584-3a9b-4d5e-85a1-dccbe828d715"
              }}
          ...
          <View style={styles.View_I0_783_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/5b31c057-c55e-4b57-830b-4f3d4508de5a"
              }}
