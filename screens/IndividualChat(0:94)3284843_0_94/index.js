  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_0_792}>
        ...
        <View style={styles.View_0_818}>
          ...
          <ImageBackground
            source={{
              uri:
                "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/13e04cba-8ba0-40c2-9c49-917c99becb26"
            }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/b36c6037-386f-4de0-9c67-d0dbf6692e04"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/99c52c3a-2879-4800-af06-084d8c970ff1"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f01a47ba-6c8a-404b-8433-d0d6e822b5c6"
        }}
        ...
        <View style={styles.View_I0_785_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3811b9f1-e186-44ad-86d1-5d619790f502"
              }}
          ...
          >
            <View style={styles.View_I0_785_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f14173ee-8d9c-4bb3-931a-c56ec7394ae9"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/0d0d4c42-0d3d-4f22-94e1-116b02a98c7c"
              }}
        ...
        <View style={styles.View_I0_780_0_49}>
          <View style={styles.View_I0_780_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/bf95aff3-855b-4e1f-86da-fabfb034d473"
              }}
          ...
          <View style={styles.View_I0_780_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/e42b4b08-d5a8-4c0f-8627-ed618f8ff8dd"
              }}
          ...
          <View style={styles.View_I0_780_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/051bd38d-d884-4193-9ce3-878015f05224"
              }}
