    ...
    >
      ...
      >
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c6d8ae49-8daf-4940-a491-cba37977ae65"
          }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f8d59ffe-be9b-492d-896c-a15739368a9e"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/2e64c38b-5555-49c9-90be-0c178d52862b"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/681f5c73-32c9-43d6-b605-f6ef34038446"
        }}
        ...
        <View style={styles.View_I0_784_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/66949599-44e8-4112-944e-0592cada5310"
              }}
          ...
          <View style={styles.View_I0_784_0_626}>
            <View style={styles.View_I0_784_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/bf903aa0-982c-4e31-a06c-d07c923721b9"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ae2ee81f-360f-42ac-ac74-a3cdedc6fedb"
              }}
        ...
        <View style={styles.View_I0_783_0_49}>
          <View style={styles.View_I0_783_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/2885ac21-28fd-4500-bd46-cd33469fc356"
              }}
          ...
          <View style={styles.View_I0_783_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ddda1e05-3baf-4faf-9144-9565d5f30e55"
              }}
          ...
          <View style={styles.View_I0_783_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/71df05be-ebcb-4095-8817-df116c1cf6a5"
              }}
