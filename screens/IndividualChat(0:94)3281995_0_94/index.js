  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_0_792}>
        ...
        <View style={styles.View_0_818}>
          ...
          <ImageBackground
            source={{
              uri:
                "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/81dc7424-2634-4886-b61d-b2c06dd0952f"
            }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/81558b94-1466-42c3-a963-18c316027c9e"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6b01d133-62a8-4625-a98f-619b7dda0ae6"
        }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/0f0919c2-8003-49f2-9b7c-b9205b8afb82"
        }}
        ...
        <View style={styles.View_I0_785_0_588}>
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ecd0cc3e-c63b-4340-993b-0b099b92a5e4"
              }}
          ...
          >
            <View style={styles.View_I0_785_0_628}>
              <ImageBackground
                source={{
                  uri:
                    "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/86f39cf7-154b-4b1b-8050-f93e7616e93c"
                }}
          ...
          >
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d0a09d11-4e56-448a-973e-628fe0538bde"
              }}
        ...
        <View style={styles.View_I0_780_0_49}>
          <View style={styles.View_I0_780_0_51}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/4bf2aca4-4076-4ca8-a08a-a7fd2c08a8ac"
              }}
          ...
          <View style={styles.View_I0_780_0_55}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/54fb2ae4-ac36-427a-9e07-920a8630d398"
              }}
          ...
          <View style={styles.View_I0_780_0_60}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/7da28e1a-5a5f-4932-9a93-ace24aecc545"
              }}
